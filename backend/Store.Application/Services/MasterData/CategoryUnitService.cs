...
public class CategoryService : ICategoryService
{
    ...
    private const string CacheKey = "categories_dropdown";

    public CategoryService(ICategoryRepository categoryRepository, IAuditLogRepository auditLogRepository, IMemoryCache cache)
    {
...
public class UnitService : IUnitService
{
    ...
    private readonly IAuditLogRepository _auditLogRepository;
    private readonly IMemoryCache _cache;
    private const string CacheKey = "units_dropdown";

    public UnitService(IUnitRepository unitRepository, IAuditLogRepository auditLogRepository, IMemoryCache cache)
    {
